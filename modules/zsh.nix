{ config, pkgs, ... }:
{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      deltacomp = "ssh -l jmyers4 dtai-login.delta.ncsa.illinois.edu";
      ...
      cs483 = "cd ~/School/spring2026/cs483";
      cs300 = "cd ~/School/spring2026/cs300";
      cs402 = "cd ~/School/spring2026/cs402";
      cs410 = "cd ~/School/spring2026/cs410";
      mth491 = "cd ~/School/spring2026/mth491";
    };
